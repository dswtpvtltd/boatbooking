   ...
   public function execute()
   {
       ...
       $data = $this->getRequest()->getPostValue();
        ...
        if ($data) {
            ...
            $enquirydata['traffic_id'] = $this->_cookieManager->getCookie("aw-affiliate-statistic");
                ...
                if($model->save()){
                    ...
                    $Curl_Session =  curl_init("https://www.smsglobal.com/http-api.php");
                                                ...
                                                curl_setopt ($Curl_Session, CURLOPT_POSTFIELDS, 'action=sendsms&user=anyboat&password=8r9yx3ub&&from=Any Boat&to=0431552233,0414984477&text='.$msg);
                    ...
                    $from = array(
                      'email' => $this->_escaper->escapeHtml("boats@anyboat.com.au"),
          ...
          mail("devvidya2004@gmail.com","error in enquiry form from IP ".$_SERVER['REMOTE_ADDR'],$ex->getMessage());
          $this->messageManager->addError(__($ex->getMessage()));
          return $resultRedirect->setPath('boatbooking/boat');
      }catch (LocalizedException $e) {
          mail("devvidya2004@gmail.com","error in enquiry form from IP ".$_SERVER['REMOTE_ADDR'],$e->getMessage());
